...
public class myGridViewAdapter extends BaseAdapter{  
    ...
    @Override  
    public int getCount() {
	    if (myMaps.m_lstMaps == null) return 1;
        else return myMaps.m_lstMaps.size();
    }  
                    ...
                    for (int j = 0; j < nd.Cols; j++) {
                        ...
                        switch (Arr[i].charAt(j)) {
                            ...
                            case '#':
                                ...
                                break;
                            case '-':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                break;
                            case '.':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                rt1.set(0, 100+myMaps.isSkin_200, 50, 150+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                break;
                            case '$':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                rt1.set(50, 50+myMaps.isSkin_200, 100, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                break;
                            case '*':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                ...
                                rt1.set(0, 100+myMaps.isSkin_200, 50, 150+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                rt1.set(50, 100+myMaps.isSkin_200, 100, 150+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                break;
                            case '@':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                rt1.set(100, 50+myMaps.isSkin_200, 150, 100+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                break;
                            case '+':
                                rt1.set(0, 50+myMaps.isSkin_200, 50, 100+myMaps.isSkin_200);
                                ...
                                rt1.set(0, 100+myMaps.isSkin_200, 50, 150+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                                rt1.set(100, 100+myMaps.isSkin_200, 150, 150+myMaps.isSkin_200);
                                cvs.drawBitmap(myMaps.skinBit, rt1, rt, null);
                        } //end switch
