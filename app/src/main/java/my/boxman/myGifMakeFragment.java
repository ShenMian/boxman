    ...
    private final class AsyncGifMakeTask extends AsyncTask<Void, String, String> {
        ...
        protected void onPreExecute() {
            ...
            try {
                ...
                if (m_Skin) {  //现场皮肤
                    rtF.set(0, m_PicWidth+myMaps.isSkin_200, m_PicWidth, m_PicWidth*2+myMaps.isSkin_200);  //地板
                    rtD.set(0, m_PicWidth*2+myMaps.isSkin_200, m_PicWidth, m_PicWidth*3+myMaps.isSkin_200);  //目标
                    rtB.set(m_PicWidth, m_PicWidth+myMaps.isSkin_200, m_PicWidth*2, m_PicWidth*2+myMaps.isSkin_200);   //箱子
                    rtBD.set(m_PicWidth, m_PicWidth*2+myMaps.isSkin_200, m_PicWidth*2, m_PicWidth*3+myMaps.isSkin_200);  //目标上的的箱子
                    if (myMaps.isSimpleSkin || myMaps.isSkin_200 == 0) {  //简单皮肤
                        rtM[1].set(m_PicWidth*2, m_PicWidth+myMaps.isSkin_200, m_PicWidth*3, m_PicWidth*2+myMaps.isSkin_200);
                        rtMD[1].set(m_PicWidth*2, m_PicWidth*2+myMaps.isSkin_200, m_PicWidth*3, m_PicWidth*3+myMaps.isSkin_200);
                        rtM[0] = rtM[1];
                        rtM[2] = rtM[1];
                        rtM[3] = rtM[1];
                        rtMD[0] = rtMD[1];
